...
public class Activity2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button r = (Button) findViewById(R.id.results2);
    ...
    void DisplayMap(){
        ...
        spType.setAdapter(new ArrayAdapter<>(Activity2.this, android.R.layout.simple_spinner_dropdown_item, placeNameList));
        ...
        if (ActivityCompat.checkSelfPermission(Activity2.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(Activity2.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 44);
        }
...
//                System.out.println(url);
                new Activity2.PlaceTask().execute(url);
    ...
    private class PlaceTask extends AsyncTask<String,Integer,String> {
        ...
        protected void onPostExecute(String s) {
            new Activity2.ParserTask().execute(s);
